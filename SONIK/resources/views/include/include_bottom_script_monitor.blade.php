		...
		<script>
			...
			if( base64_decode(Session::pull('show_popup')) == 1 ){
				...
				if( base64_decode(Session::get('popup_type')) == "error" ){
					$popup_heading = "Oops!";
				} else if( base64_decode(Session::get('popup_type')) == "success" ){
					$popup_heading = "Success";
				}
				...
				var SweetAlert2Demo = function() {
				    ...
				    var initDemos = function() {
						swal("<?php echo $popup_heading;?>", "<?php echo base64_decode(Session::get('popup_message'));?>", "<?php echo base64_decode(Session::get('popup_type'));?>");
				    };

				    return {init: function() {initDemos();},};
				}();
