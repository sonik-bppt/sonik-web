									...
									<div class="m-portlet m-portlet--tab">
										...
										<div class="m-portlet__body">
                                            <div class="form-group m-form__group" style="padding-left:0;">
                                                ...
                                                <input type="text" id="inputUsername" class="form-control m-input m-input--square" placeholder="Example: 8FEDD5E9" name="textIDTag" required >
                                            </div>
                                            <div class="form-group m-form__group" style="padding-left:0;">
                                            ...
                                            <div class="dropdown bootstrap-select show-tick form-control form-control--fixed">
