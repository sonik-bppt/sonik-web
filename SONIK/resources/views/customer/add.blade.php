									...
									<div class="m-portlet m-portlet--tab">
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group" style="padding-left:0;">
												...
												<input type="text" id="inputName" class="form-control m-input m-input--square" placeholder="Your full name as stated in your government ID" name="textName" value="" required >
											</div>
											<div class="form-group m-form__group" style="padding-left:0;">
												<label for="exampleInputEmail1">Email</label>
												<input type="email" id="inputUsername" class="form-control m-input m-input--square" placeholder="Example: sample.email@gmail.com" name="textEmail" value="" required >
											</div>
											<div class="form-group m-form__group" style="padding-left:0;">
												<label for="exampleInputEmail1">Phone Number</label>
												<input type="text" id="inputUsername" class="form-control m-input m-input--square" placeholder="Example: 08123456789" name="textPhoneNumber" value="" required >
											</div>
									...
									<div class="m-portlet m-portlet--tab">
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group" style="padding-left:0;">
												...
												<input type="text" id="inputUsername" class="form-control m-input m-input--square" placeholder="Example: 8FEDD5E9" name="textIDTag" value="" required >
											</div>
