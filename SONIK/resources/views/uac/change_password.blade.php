							...
							<div class="d-flex align-items-center">
								<div class="mr-auto">
									...
									<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
										...
										<li class="m-nav__item">
											<a class="m-nav__link">
												<span class="m-nav__link-text">My Password</span>
											</a>
										</li>
									</ul>
								</div>
									...
									<div class="m-portlet m-portlet--tab">
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group" style="padding-left:0;">
												...
												<input type="password" id="inputName" class="form-control m-input m-input--square" name="current_password" required >
											</div>
											<div class="form-group m-form__group" style="padding-left:0;">
												<label for="exampleInputEmail1">New Password</label>
												<input type="password" id="inputUsername" class="form-control m-input m-input--square" name="new_password" required >
											</div>
											<div class="form-group m-form__group" style="padding-left:0;">
												<label for="exampleInputEmail1">Confirm New Password</label>
												<input type="password" id="inputUsername" class="form-control m-input m-input--square" name="confirm_new_password" required >
											</div>
