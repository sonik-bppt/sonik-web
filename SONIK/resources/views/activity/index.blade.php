	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-light m-aside-left--fixed m-aside-left--offcanvas m-aside-left--minimize m-brand--minimize m-footer--push m-aside--offcanvas-default">
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				@include('activity.include_left_aside')
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Activity History</h3>
										...
										<div class="m-widget24">
											<div class="m-widget24__item">
												...
												<span class="m-widget24__desc">
													Number of activity occur
												</span>
												<span class="m-widget24__stats m--font-warning">
													{{ number_format($activity_lifetime) }}
												</span>
										...
										<div class="m-widget24">
											<div class="m-widget24__item">
												...
												<span class="m-widget24__stats m--font-danger">
													{{ number_format($activity_this_year) }}
												</span>
												<div class="m--space-10"></div>
												<div class="progress m-progress--sm">
										...
										<div class="m-widget24">
											<div class="m-widget24__item">
												...
												<span class="m-widget24__stats m--font-info">
													{{ number_format($activity_this_month) }}
												</span>
												<div class="m--space-10"></div>
												<div class="progress m-progress--sm">
								...
								<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
									...
									<tbody>
										...
										@foreach($activity as $this_activity)
											...
											<tr>
												<td>{{ $i }}</td>
												<td><i class="fas fa-info fa-fw text-info text-5 va-middle"></i><span class="va-middle">Info</span></td>
												<td>{{ $this_activity->CHARGE_BOX_ID }}</td>
												<td>{{ $this_activity->CONNECTOR_NAME }}</td>
												<td>{{ $this_activity->STATUS_TIMESTAMP_GMT7 }}</td>
												<td>{{ $this_activity->STATUS }}</td>
												<td>{{ $this_activity->VENDOR_ID }}</td>
												<td>{{ $this_activity->ERROR_INFO }}</td>
											</tr>
